import"./modulepreload-polyfill-B5Qt9EMX.js";import"./preload-helper-D33vDyUH.js";import{i as D}from"./themeService-BgIb2Nl3.js";import{d as $,j as x}from"./folderService-CcR8-Orv.js";import{a as I,r as B}from"./notificationService-DwiMN6DO.js";import{t as P,b as r,d as k}from"./noteService-DbdrNuO8.js";import{a as F,b as N,p as M,s as C}from"./syncService-BQUdfgLS.js";import"./quickNote-Doto7KFv.js";I();B();D();F()&&N().then(()=>M()).finally(()=>C(3e4));const{App:u}=window.Capacitor?.Plugins||{};let m=!1,b=null;u&&u.addListener("backButton",()=>{if(m){clearTimeout(b),u.exitApp();return}m=!0,A(),b=setTimeout(()=>{m=!1},2e3)});function A(){const e=document.getElementById("exitToast");e&&e.remove();const t=document.createElement("div");t.id="exitToast",t.textContent="Press back again to exit",t.style.cssText=`
        position: fixed;
        bottom: 90px;
        left: 50%;
